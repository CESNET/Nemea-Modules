...
time_last_file = ARG2
title_suffix = ARG3
title_suffix_no_underscores = system("echo ".ARG3." | sed 's,_, ,g'")
...
set title sprintf("TIME FIRST %s", title_suffix_no_underscores)
set xlabel "Age (s)"
...
# Set the title and axis labels
set title sprintf("TIME LAST %s", title_suffix_no_underscores)
set xlabel "Age (s)"
set ylabel "Percentage (%)"
set y2label "Number of Flows"
