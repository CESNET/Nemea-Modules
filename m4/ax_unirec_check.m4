...
AC_DEFUN([AX_UNIREC_CHECK], [
  ...
  AC_PATH_PROG(UNIRECPROC, unirec_generate_fields_files.py, [],
      [./nemea-framework/unirec$PATH_SEPARATOR$PWD/../nemea-framework/unirec$PATH_SEPARATOR$PWD/../unirec$PATH_SEPARATOR$PATH])
  else
  AC_PATH_PROG(UNIRECPROC, unirec_generate_fields_files.py, [],
      [./nemea-framework/unirec$PATH_SEPARATOR$PWD/../nemea-framework/unirec$PATH_SEPARATOR$PATH$PATH_SEPARATOR/usr/bin/nemea$PATH_SEPARATOR$PWD/../unirec$PATH_SEPARATOR])
  fi
  ...
  PKG_CHECK_MODULES([unirec], [unirec], [UNIRECLIB="yes"], [
    ...
    if test -d "$srcdir/../unirec"; then
      ...
      UNIRECINC='$(top_srcdir)/../../'
      UNIRECLIB='$(top_builddir)/../../unirec/.libs/'
    elif test -d "./nemea-framework/unirec"; then
      UNIRECINC='./nemea-framework/'
      UNIRECLIB='./nemea-framework/unirec/.libs/'
